...
public class PanelUpdateNacional extends JPanel {

	private JButton btnBack, btnUpdate,btnBackDark, btnUpdateDark;
	private JTextArea newData, numPasajeros, horaSalida, horaLlegada, vuelos, nombrePiloto, nombreCopiloto, listaPilotos;
	private JComboBox nomEmpresa, turbinaOHelice;
	private JLabel lblBright,lblDark, avianca, latam, wingo, emirates, labelNewData,labelPasajeros, labelEmpresa, labelHoraSalida, labelHoraLLegada, labelCombo, labelListaVuelos, lblLogo, lblLogoDark, labelNombrePiloto, labelNombreCopiloto, labelListaPilotos;
	
	public PanelUpdateNacional() {
		...
		numPasajeros.setBounds(30, 185, 250, 30);
		...
		add(horaLlegada);
		 ...
		 labelCombo = new JLabel("Nuevo tipo de motor del avión:");

		labelCombo.setFont(fontlbl);
		add(labelCombo);

		String[] opciones = { "Turbina", "Hélice" };
		turbinaOHelice = new JComboBox<>(opciones);
		

		turbinaOHelice.setFont(fontlbl);
		add(turbinaOHelice);
		...
		numPasajeros.setBounds(300, 100, 250, 30);
		...
		turbinaOHelice.setBounds(570, 160, 200, 30);
	...
	public JComboBox getTurbinaOHelice() {
		return turbinaOHelice;
	}

	public void setTurbinaOHelice(JComboBox turbinaOHelice) {
		this.turbinaOHelice = turbinaOHelice;
	}
